...
app.controller('TrainingPlanCtrl', function ($scope) {
    ...
    $scope.sports = [
        {
            name: "Триатлон (спринтерська та олімпійська дистанції)",
            showPartsFor: {
                speed: true,
                distance: true,
                race: true,
